...
function Start()
{
	...
	function FixedUpdate () 
	{
		...
		else
		{
			...
			if(allowShot)
			{
				var projetilePrefab : GameObject = Resources.Load("Cross") as GameObject;
				var Projectile : GameObject = Instantiate(projetilePrefab, this.transform.position, Quaternion.identity);
				allowShot = false;
			}
		}
	}
